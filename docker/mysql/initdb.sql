...
(1,1,'WordPress コメントの投稿者','wapuu@wordpress.example','https://ja.wordpress.org/','','2023-11-08 22:27:22','2023-11-08 13:27:22','こんにちは、これはコメントです。\nコメントの承認、編集、削除を始めるにはダッシュボードの「コメント」画面にアクセスしてください。\nコメントのアバターは「<a href=\"https://ja.gravatar.com/\">Gravatar</a>」から取得されます。',0,'1','','comment',0,0);
...
(91,'admin_email_lifespan','1715002042','yes'),
...
(1,'admin','$P$BWLkSpzVREqf4br0WsNCMI0yLDYt4g0','admin','dev@example.com','http://localhost','2023-11-08 13:27:22','',0,'admin');
...
-- Dump completed on 2023-11-08 14:08:10
